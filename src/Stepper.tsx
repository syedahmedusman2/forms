    ...
    <div className={classes.root}>
      ...
      <div>
        {activeStep === steps.length ? (
          <div>
            <Typography style={{color: 'red'}}>Wait for the confirmation email for scholorship</Typography>
          ...
          <div>
            ...
            <button onClick={handleNext} style={{backgroundColor: 'navy', color: 'white', width: '100px', height: '30px', borderRadius:'12px'}}>Submit</button>
          </div>
        )}
      </div>
    </div>
